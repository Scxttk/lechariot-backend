...
/// Ketten, deren Angebote beim On-Demand-Sync aus einer bereits gesyncten
/// Region kopiert werden, bevor irgendein Scraper läuft — reine
/// Sofort-Anzeige, siehe [`seed_national_chains`].
///
/// **ALDI steht seit Phase 12 nicht mehr hier.** Es gibt nichts mehr zu
/// kopieren: Der Katalog liegt bundesweit unter einer einzigen Filiale
/// (`Store::stores_nationally`) und ist in jeder Region ab dem ersten
/// Augenblick sichtbar. Übrig bleibt Lidl, dessen Prospekt an der Filiale
/// hängt — dort ist die Kopie eine Näherung, und genau das ist der offene
/// Punkt „Vorab-Kopie klären".
pub const SEED_CHAINS: [&str; 1] = ["Lidl"];
