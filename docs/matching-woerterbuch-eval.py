...
V = {
 ...
 "käse":(["käse","kaese","käsescheiben","käsesnack","cottage","gouda","emmentaler","edamer","maasdamer","bergkäse","butterkäse","cheddar","parmesan","grana","halloumi","finello"],["käse","kaese"],["käsekuchen","frischkäse","croissant","leberkäse","laugenstange","laugengebäck","brezel","käsebrötchen","käsestange","käsegebäck","fleischkäse"]),
 ...
 "fisch":(["lachs","lachsfilet","forelle","kabeljau","seelachs","garnelen","shrimps","fischstäbchen","matjes","hering","thunfisch","räucherlachs","lachsseite","dorade","doraden","kabeljauloin","wildlachs"],["fisch","filet"],["fischsauce","schwein","schweine","lamm","lammfilets","kasseler","hähnchen","brustfilet","innenfilet","putenbrustfilet"]),
